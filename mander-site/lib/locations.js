...
//
// Metro Vancouver is the studio's one dedicated local-SEO region: the one
// market the local growth work is actually aimed at. Delivery is remote —
// nothing here claims the team is physically in the region, because it is
// not, and a local-SEO page that opens with a presence it doesn't have is
// the first thing a reader checks and the first thing they catch. Massachusetts and Rhode
...
const NA_REGIONS = [
  {
    ...
    intro: [
      'Metro Vancouver is the one region the local growth work is aimed at. The studio is remote and works with businesses here the way it works with everyone — over email and video — so this is a choice about focus rather than a claim about an office. That is a deliberate narrowing rather than a limitation: local search is won by being genuinely relevant to one place before being thinly present in twenty, and a studio that claims every city on the map is telling you it has traction in none of them.',
    ...
    proximityNote: 'MANDER is a remote studio. Metro Vancouver is the one region the local search work is built around.',
    industries: [
      'Technology & startups',
    ...
    faqs: [
      {
        ...
        a: 'MANDER is a remote studio rather than a company with a BC office — most of the team is in Massachusetts and Maine, and the rest works remotely. Metro Vancouver is the one market the local search work is built around, and invoicing in Canadian dollars is normal here.',
      },
      {
    ...
    cities: [
      ...
      },
      {
        ...
        metaDescription:
          'Website design for Langley, BC businesses — trades, agriculture and professional services across the Fraser Valley. Fixed-price builds, quoted up front.',
        intro:
          "Langley is a Fraser Valley mix of trades and construction, agriculture, and a growing professional-services base — businesses that mostly built their reputation locally and are only now working out that reputation doesn't show up in a Google search unless something is actually built to be found.",
        industries: ['Trades & construction', 'Agriculture & agritourism', 'Professional services', 'Retail'],
        faqs: [
          {
            q: 'Is MANDER actually based in Langley?',
            a: 'No — MANDER is a remote studio, with most of the team in Massachusetts and Maine. Langley is part of the one region the local search work is aimed at, and everything from the first call to handover happens over email and video, so the distance changes neither the price nor the timeline.',
          },
          {
            q: 'Do you invoice in Canadian dollars?',
            a: 'Yes, CAD on request at no extra cost, with the price fixed and agreed before anything starts.',
