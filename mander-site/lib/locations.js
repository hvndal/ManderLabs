...
export const REGIONS = [
  {
    ...
    cities: [
      ...
      },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'No — Launch is tailored specifically for businesses that need a real, professional presence without agency-level overhead.',
          },
                  {
      ...
      },
      {
        ...
        metaDescription:
          'Website design for Springfield, MA and the Pioneer Valley — manufacturing, logistics, healthcare and trades. Tailored scope and transparent pricing.',
        intro:
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Sometimes. App Growth covers bookings, accounts and an admin dashboard, which suits dispatch or job tracking. If the need is really just being found and contacted, a Growth site with local SEO does more for less.",
          },
          {
      ...
      },
      {
        ...
        faqs: [
          {
            q: 'Is a Launch site too basic for a professional practice?',
      ...
      },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Yes — custom Android builds are scoped around your exact interface requirements, and the interface language is a design decision, not an add-on. The same applies to the website copy for Quincy businesses serving two languages.",
          },
          {
      ...
      },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Occasionally, but rarely first. Local SEO on a Growth site usually wins more Framingham customers per dollar than a custom mobile app, and the app makes sense once you have repeat customers to keep.",
          },
          {
        ...
        faqs: [
          {
            ...
            a: "That's specifically what Launch is — a single-page site that looks considered, not like a template, with tailored scoping. Most Brockton inquiries land in Launch or Starter.",
          },
          {
            ...
            a: 'Yes — calls run in English, but the site itself can carry Creole or Portuguese content where your customers need it.',
                  ...
                  {
            q: "Is a custom mobile app realistic for a Brockton business?",
          ...
          {
            q: "What is the most accessible way to get a real site online?",
            a: "A Launch tier build, with the 20% Community Rate if you ask for it. One page, mobile-first, a contact form and a Google Maps link — about two weeks.",
          },
        ],
      },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Yes, deployed to Google Play under your own developer account. For trades and healthcare on the North Shore that is usually scheduling or a customer request flow.",
          },
          {
            q: "Can you take over a site someone else built badly?",
            a: "Usually we rebuild rather than patch — a Growth rebuild costs less than untangling someone else’s legacy work, and you end up owning something maintainable.",
          },
        ],
      },
    ],
    ...
    cities: [
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Yes — App Growth covers accounts, payments, bookings and an admin dashboard. If it is just table reservations, a Growth site with booking integration is the lighter answer.",
          },
          {
      ...
      },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "For most Warwick retail and trades, a website is enough — a tailored Growth site with local SEO covers being found and contacted. Custom apps earn their keep when customers come back repeatedly.",
          },
          {
      ...
      },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Yes. Every build gets a performance budget and a Core Web Vitals pass, and our Care Plan covers high-availability cloud hosting — which is the part that usually buckles in a Newport summer.",
          },
        ],
      },
    ],
