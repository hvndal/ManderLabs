...
// --- Team -----------------------------------------------------------------
// Seven people: Connar runs the company; Herman out of Langley, BC; Tyler,
// Sophie and Evan out of Maynard, MA; Danielle and Nick out of Portland, ME.
// Kept to a handful of towns rather than scattering across seven cities for a
// seven-person company, which would read as stock-photo staffing — the pitch
// here is "small, senior, reachable".
//
// Langley is load-bearing beyond this file: it is the first-hand basis for
// every Metro Vancouver local-search claim in lib/locations.js. It is a base,
// not a desk — the work travels across Canada — but the base is real, and the
// region pages are written on the strength of it. Change it here and those
// claims have to be revisited in the same commit.
//
...
export const TEAM = [
  ...
  },
  {
    ...
    location: 'Maynard, MA',
    bio: 'Trained as an industrial designer, moved to the web when tooling cycles got shorter than furniture ones. Owns the component library and most of the front end — and is the only person here allowed to say "let us circle back on that", on the grounds that he has usually already fixed it by the time anyone circles.',
  ...
  },
  {
    ...
    role: 'Technical Lead',
    location: 'Maynard, MA',
    bio: 'Handles the parts clients never see — hosting, performance budgets, integrations, and the security work that keeps a small business off an incident report. The highest compliment her work gets is that nobody ever had a reason to phone about it.',
  ...
  },
  {
    ...
    location: 'Maynard, MA',
    bio: 'Moved from the Philippines to New England as a child and has been translating between people ever since — which turns out to be most of what scoping a project actually is. First call, written scope, and the one who keeps you posted, so you are never the person chasing an update.',
    photo: '/team/evan.jpg',
  },
];
