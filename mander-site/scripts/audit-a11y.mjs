...
const routes=['/','/work','/brand','/digital','/growth','/pricing','/quote','/contact','/about','/locations/metro-vancouver/vancouver','/locations/metro-vancouver/burnaby','/legal/refunds','/blog','/careers','/locations','/locations/metro-vancouver'];
