...
// The display face. Archivo held this job for one revision and it was the
// wrong call: a grotesque at display size reads as software, and what this
// studio is selling is closer to a fashion title than to a documentation
// site. Instrument Serif is high-contrast and slightly condensed — it carries
// an editorial voice at large sizes the way a masthead needs to, and it sets
// up the three-way contrast the design system was always describing: serif
// display, grotesk body, mono label.
//
