...
const PATHS = {
  ...
  phone: (
    <path d="M6.5 4h3l1.5 3.6-2 1.4a11 11 0 0 0 5 5l1.4-2L19 13.5v3a1.6 1.6 0 0 1-1.8 1.6A13.6 13.6 0 0 1 5 6.8 1.6 1.6 0 0 1 6.5 4z" />
  ),
  mail: (
    <>
      <rect x="3" y="5.5" width="18" height="13" rx="1.5" />
      <path d="M3.6 6.4l8.4 6.4 8.4-6.4" />
    </>
  ),
