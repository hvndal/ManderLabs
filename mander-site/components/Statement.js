      ...
      <section className={`${tones[tone] || tones.paper}`}>
        <div className="container-max grid grid-cols-1 gap-y-8 stack-y md:grid-cols-12 md:gap-gutter">
          ...
          <div className="md:col-span-9 md:col-start-4">
            <Reveal delay={90}>
              <p className="max-w-[20ch] font-editorial text-headline-lg-mobile leading-[1.08] md:max-w-[16ch] md:text-display-lg">
                {text}
              </p>
            </Reveal>
          </div>
    ...
    <section className={`${tones[tone] || tones.paper} border-b border-line`}>
      <div className="container-max stack-y">
        <Reveal className="mx-auto max-w-4xl text-center">
          ...
          <p className="font-editorial text-headline-lg-mobile leading-[1.15] md:text-headline-lg">
            {text}
          </p>
        </Reveal>
      </div>
