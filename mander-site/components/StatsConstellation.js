          ...
          <Reveal>
            <div className="relative">
              <div className="flex items-end gap-6 md:gap-10">
                <span className="whitespace-nowrap font-display text-[22vw] leading-[0.82] tracking-[-0.02em] text-ink md:text-[15.5vw]">
                  {first.value}
                </span>
          ...
          <Reveal delay={120}>
            <div className="mt-20 flex justify-end md:mt-28">
              <div className="max-w-[34ch] text-right">
                <span className="block font-display text-stat-xl leading-none text-ink">
                  {second.value}
                </span>
        ...
        {third && (
          <Reveal delay={200}>
            <div className="mt-16 max-w-[26ch] md:mt-20">
              <span className="block font-display text-stat-md leading-none text-ink">
                {third.value}
              </span>
